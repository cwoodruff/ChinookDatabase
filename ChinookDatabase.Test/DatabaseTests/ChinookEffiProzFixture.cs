...
namespace ChinookDatabase.Test.DatabaseTests
{
    ...
    /// </summary>
    public partial class ChinookEffiProzFixture : IDisposable
    {
        ...
        /// </summary>
        [Theory]
		[InlineData("Chinook_EffiProz")]
		[InlineData("Chinook_EffiProz_AutoIncrement")]
