...
{
    /// <summary>
    /// Test fixtures for SqlServerCompact databases.
    /// </summary>
    public partial class ChinookSqlServerCompactFixture : IDisposable
    {
        protected IDictionary<string, SqlCeConnection> Connections;
        ...
        /// </summary>
        public ChinookSqlServerCompactFixture()
        {
        ...
        /// </summary>
        [Theory]
		[InlineData("Chinook_SqlServerCompact")]
		[InlineData("Chinook_SqlServerCompact_AutoIncrement")]
